 ...
 */
!function (p) {
  p.fn.convertToBackground = function (t) {
    var g = p.extend({
      repeat: "no-repeat",
    ...
    p(this).each(function (t, e) {
      var i = p(this),
          ...
          h = p("<div></div>"),
          s = "";
      o && c & d && (i.append(h), d = 0, s = 100 * g.height / g.width + "%"), o && i.find(h) ? h.css({
        backgroundRepeat: g.repeat,
        backgroundPosition: g.position,
        backgroundSize: g.size,
        backgroundAttachment: g.attachment,
        backgroundImage: "url(" + (n || g.fallbackSrc) + ")",
        height: d,
        width: "100%",
        paddingBottom: s
      }) : i.css({
    ...
    m(this).each(function (e, o) {
      ...
      d.length || (d = i), a.length > l.count && a.slice(l.count).hide(), d.on("click", function (e) {
        ...
        var o = m(this),
            t = a.filter(":hidden"),
            n = t;
        -1 !== l.itemsToLoad && 0 < l.itemsToLoad && (n = t.slice(0, l.itemsToLoad)), 0 < n.length && n.fadeIn(), (t.length <= l.itemsToLoad || -1 === l.itemsToLoad) && o.remove();
      });
    });
  };
}(jQuery);
